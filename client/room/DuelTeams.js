...
// Imports:
import { Teams, BuildBlocksSet, Spawns } from 'pixel_combats/room';
...
export const RedTeam_BUILDBLOCKSSET = BuildBlocksSet.Red;
export const BlueTeam_BUILDBLOCKSSET = BuildBlocksSet.Blue;
...
export function CreateBlueTeam() {
 ...
 Teams.Build.BlocksSet.Value = BlueTeam_BUILDBLOCKSSET;
}
